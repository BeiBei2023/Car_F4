...
void setup_scr_main(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->main_btn_1_label, "NEXT");
    ...
    lv_obj_set_pos(ui->main_btn_1, 125, 4);
    lv_obj_set_size(ui->main_btn_1, 30, 15);
    lv_obj_add_flag(ui->main_btn_1, LV_OBJ_FLAG_CLICKABLE);

    //Write style for main_btn_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->main_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->main_btn_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->main_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->main_btn_1, lv_color_hex(0x12548b), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->main_btn_1, &lv_font_SourceHanSerifSC_Regular_9, LV_PART_MAIN|LV_STATE_DEFAULT);
