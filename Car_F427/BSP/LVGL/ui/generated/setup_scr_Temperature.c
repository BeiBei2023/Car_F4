...
void setup_scr_Temperature(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->Temperature, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Temperature, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Temperature, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Temperature_btn_5
    ui->Temperature_btn_5 = lv_btn_create(ui->Temperature);
    ...
    ui->Temperature_btn_4 = lv_btn_create(ui->Temperature);
