...
void setup_scr_IO_State(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->IO_State, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->IO_State, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->IO_State, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes IO_State_btn_9
    ui->IO_State_btn_9 = lv_btn_create(ui->IO_State);
    ...
    ui->IO_State_btn_8 = lv_btn_create(ui->IO_State);
