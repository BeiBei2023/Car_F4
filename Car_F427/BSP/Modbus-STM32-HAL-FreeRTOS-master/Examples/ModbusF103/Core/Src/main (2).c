...
/**
  ...
  ******************************************************************************
  * Example running a Modbus Master and a Slave concurrently in a NUCLEO64-F103RB
  * Modbus Master: USART1 (PA10 ---> USART_RX1, PA9  ---> USART_TX1)
  * Modbus Slave:  USART3 (PB11 ---> USART_RX3, PB10 ---> USART_TX3)
  *
  ******************************************************************************
  */
